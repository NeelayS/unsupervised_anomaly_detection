...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rootdir",
        required=True,
        help="Please specify the directory containing the processed dataset",
    )
    parser.add_argument(
        "--class_info_csv",
        required=True,
    ...
    parser.add_argument(
        "--epochs", type=int, default=25, help="Please specify the number of epochs"
    )
    parser.add_argument(
        "--train_batch_size", type=int, default=4, help="Please specify the batch_size"
    )
    parser.add_argument(
        "--val_batch_size", type=int, default=4, help="Please specify the batch_size"
    )
    ...
    train_dataset, val_dataset, test_dataset = make_dataset(
        args.rootdir, args.class_info_csv
    )
